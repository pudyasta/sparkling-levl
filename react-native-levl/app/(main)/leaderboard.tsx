...
import { thropy } from '../../src/assets/images/icon';
...
import type { LeaderboardEntry } from '../../src/pages/main/repository/type/leaderboard';
import { useGetLeaderboard } from '../../src/pages/main/usecase/useGetLeaderboards';
import { useGetUserRank } from '../../src/pages/main/usecase/useGetProfile';
    ...
    >
      <View style={styles.podiumAvatar}>
        {entry.user.avatar_url ? (
          ...
          <Text fontWeight="bold" color="white" size={TextType.b1}>
            {initials}
          </Text>
        )}
      </View>
    ...
    <View style={[styles.listItem, isMe && styles.listItemMe]}>
      ...
      <View style={styles.avatarCircle}>
        {avatar ? (
          ...
          <Text fontWeight="bold" color="white" size={TextType.b2}>
            {initials}
          </Text>
        )}
      </View>
      ...
      {isMe && (
        <View style={styles.meBadge}>
          <Text size={TextType.b3} color={Colors.Primary} fontWeight="bold">
            Kamu
          </Text>
        </View>
      )}
