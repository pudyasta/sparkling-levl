...
export const DASHBOARD_RECOMMENDED_COURSES_ENDPOINT =
...
export const COURSE_DETAIL_ENDPOINT = '/courses/SLUG?include=units,category,elements,tags&lang=id';
...
export const UPDATE_ASSIGNMENT_DETAIL_ENDPOINT = '/submissions/ASSIGNMENT_ID';
...
export const TAKEOVER_QUIZ_ENDPOINT = '/quiz-submissions/SUBMISSION_ID/takeover';
export const SUBMIT_FINAL_ASSIGNMENT_ENDPOINT = '/submissions/SUBMISSION_ID/submit';
export const QUIZ_OVERVIEW_ENDPOINT = '/quiz-submissions/SUBMISSION_ID/overview';
