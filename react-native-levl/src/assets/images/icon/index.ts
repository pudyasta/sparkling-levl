...
export {
  eye, dummy, fireSvg, thropy, date, xp, xpFilled,
  courses, time, back, setting, fire, eyeOpen, eyeClose,
  searchIcon, logo, documentLock, editIcon, privacy,
  manageAccount, arrowBackBlack, exit, hidden,
};
