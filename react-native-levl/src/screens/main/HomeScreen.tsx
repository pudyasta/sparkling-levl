...
import { useGetAchievements } from '@/usecase/main/useGetProfile';
import {
              ...
              <TouchableOpacity
                onPress={() =>
                  router.push({
                    ...
                    params: { courseId: recent.course.id, slug: recent.course.slug },
                  })
                }
...
const styles = StyleSheet.create({
  header: { paddingHorizontal: 16, paddingTop: 20, paddingBottom: 32, gap: 16 },
  ...
  progressBg: { flex: 1, height: 6, borderRadius: 3, backgroundColor: '#F1F3F4', overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 3, backgroundColor: Colors.Primary },
  achItem: { width: 80, alignItems: 'center', marginRight: 16 },
  achIcon: { width: 72, height: 72, borderRadius: 16, backgroundColor: '#F1F3F4' },
});
