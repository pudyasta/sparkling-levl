...
export default function RegisterScreen() {
  ...
  const { execute, isLoading } = useRegister({
    onSuccess: () => navigation.navigate('EmailConfirmation'),
    onValidationError: (errors) => {
      ...
      if (errors.password_confirmation) confirmPasswordRef.current?.setError(errors.password_confirmation);
    },
    onError: (err) => {
      ...
      >
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <AppButton label="Sign Up" onPress={handleRegister} isLoading={isLoading} disabled={isLoading} />
